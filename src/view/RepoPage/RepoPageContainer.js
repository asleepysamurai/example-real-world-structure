...
import RepoComponent from '../_shared/RepoComponent'
import UserComponent from '../_shared/UserComponent'
import ListComponent from '../_shared/ListComponent'
...
class RepoPage extends Component {
    ...
    renderUser(user) {
        return <UserComponent user={user} key={user.login} />
    }
    ...
    render() {
        ...
        <RepoComponent repo={repo}
              owner={owner} />
        <hr />
        <ListComponent renderItem={this.renderUser}
              items={stargazers}
